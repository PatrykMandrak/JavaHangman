...
public class Controller{
    ...
    public static String cityAndCapitol;
    ...
    public static void mainController(){
        ...
        FileHandler.getTxtFileString("countries_and_capitals.txt");
        FileHandler.getHangmanArt("hangman.txt");
        cityAndCapitol = FileHandler.stringSpliter();
        capitol = FileHandler.cityAndCapitolSpliter().toUpperCase();
